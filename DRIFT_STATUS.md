...
- [ ] **App.tsx refactor IN PROGRESS** — see `REFACTOR_HANDOFF.md`; resume with `/continue-refactor`. useDriftActions + **useMessageStream COMPLETE** (App.tsx 4075→3275). Next: `continueWithModel` → then DriftPanel.tsx. ⚠️ Two Gemini keys exposed — **rotate in Google AI Studio** (details in handoff).
